...
.food:                  ; create new food item
    ...
    add BYTE [bx], 0x30 ;   place food item and check if position was empty by incrementing character
.input:                 ; handle keyboard input
    mov bx, 0xF9C       ; initialize BX
    jc .food            ;     if position was occupied by snake in food generation => try again, if we came from main loop CF=0
    ...
    jnc .input          ; loop to keyboard input
